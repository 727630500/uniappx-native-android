...
val errorCodes: Map<ErrorCode, String> = Map(_uA(
    _uA(
        10001,
        "系统错误"
    ),
...
open class InnerAudioContextImpl : InnerAudioContext {
    ...
    private var OnCanplayCallbackArray: UTSArray<OnCanplayCallback> = _uA()
    private var OnEndedCallbackArray: UTSArray<OnEndedCallback> = _uA()
    private var InnerAudioContextOnStopCallbackArray: UTSArray<InnerAudioContextOnStopCallback> = _uA()
    private var InnerAudioContextOnErrorCallbackArray: UTSArray<InnerAudioContextOnErrorCallback> = _uA()
    private var OnPauseCallbackArray: UTSArray<OnPauseCallback> = _uA()
    private var OnPlayCallbackArray: UTSArray<OnPlayCallback> = _uA()
    private var OnSeekedCallbackArray: UTSArray<OnSeekedCallback> = _uA()
    private var OnSeekingCallbackArray: UTSArray<OnSeekingCallback> = _uA()
    private var OnTimeUpdateCallbackArray: UTSArray<OnTimeUpdateCallback> = _uA()
    private var OnWaitingCallbackArray: UTSArray<OnWaitingCallback> = _uA()
    constructor(){
    ...
    override var src: String
        ...
        set(v: String) {
            ...
            if (v.startsWith("/static")) {
                this._src = UTSAndroid.getResourcePath(v)
            }
            try {
                clearTimeout(this._timer)
                ...
                if (this._src.startsWith("/android_asset/")) {
                    val context = UTSAndroid.getUniActivity()!!
                    val afd = context.getResources()!!.getAssets().openFd(this._src.replace("/android_asset/", ""))
    ...
    override fun destroy() {
        ...
        this.OnCanplayCallbackArray = _uA()
        this.OnEndedCallbackArray = _uA()
        this.InnerAudioContextOnStopCallbackArray = _uA()
        this.InnerAudioContextOnErrorCallbackArray = _uA()
        this.OnPauseCallbackArray = _uA()
        this.OnPlayCallbackArray = _uA()
        this.OnSeekedCallbackArray = _uA()
        this.OnSeekingCallbackArray = _uA()
        this.OnTimeUpdateCallbackArray = _uA()
        this.OnWaitingCallbackArray = _uA()
    }
