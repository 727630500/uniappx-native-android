...
open class GenComponentsFullScreenResultFullScreenResult : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenComponentsFullScreenResultFullScreenResult) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenComponentsFullScreenResultFullScreenResult
            ...
            val nowItem = ref<answerItem2?>(null)
            val subProblemListLength = computed(fun(): Number {
                return nowItem.value?.appProblemList?.get(0)?.subProblemList?.length ?: 0
            }
            )
            ...
            val yWtext = computed(fun(): String {
                return "" + replaceNewlineWithBr(nowItem.value?.appProblemList?.get(0)?.soundInfoList?.get(0)?.originalText ?: "")
            }
            )
            ...
            val nowAnswer = computed(fun(): String? {
                return JSON.stringify(nowItem.value?.appProblemList?.get(0))
            }
            )
            ...
            fun gen_processRichText_fn(rich: AppProblemList2): UTSArray<UTSArray<resultItem>>? {
                ...
                val lineBreakRegex = UTSRegExp("\r?\n")
                val lines = normalizedText.split(lineBreakRegex)
            ...
            fun gen_getDetail_fn() {
                uni_request<Result<answerItem2>>(RequestOptions(url = getUrl("/biz/problem/api/getExerciseRecordDetail"), method = "GET", data = object : UTSJSONObject() {
                    ...
                    currentType.value = responseData.data?.appProblemList?.get(0)?.problemType
                    nowItem.value = responseData.data
                    if (currentType.value == "33") {
                        var _arr = processRichText(nowItem.value!!.appProblemList!![0])!!
                    ...
                    if (isTrue(unref(isVisible))) {
                        _cE("view", _uM("key" to 0, "class" to "d_content"), _uA(
                                    ...
                                    if (isTrue(unref(currentType) == "31" || unref(currentType) == "32")) {
                                        _cE(Fragment, _uM("key" to 0), _uA(
                                            _cE("scroll-view", _uM("direction" to "vertical", "style" to _nS(_uM("margin" to "12rpx 19rpx"))), _uA(
                                                _cE("view", null, _uA(
                                                    _cE("rich-text", _uM("nodes" to (unref(nowItem)?.appProblemList?.get(0)?.questionContent ?: "")), null, 8, _uA(
                                                        "nodes"
                                                    ))
                                                ))
                                            ), 4),
                                            _cE(Fragment, null, RenderHelpers.renderList(unref(nowItem)?.appProblemList?.get(0)?.subProblemList, fun(item, index, __index, _cached): Any {
                                                return _cE("view", null, _uA(
                                                    if (index === 0) {
                                                        _cE("view", _uM("key" to 0, "style" to _nS(_uM("margin" to "0 0 0 11rpx", "align-items" to "flex-start"))), _uA(
                                                            _cE("view", null, _uA(
                                                                _cV(_component_u_playMp3, _uM("style" to _nS(_uM("align-items" to "flex-start")), "src" to (unref(nowItem)?.appProblemList?.get(0)?.soundInfoList?.get(0)?.soundUrl ?: ""), "tplType" to 6, "disabled" to (unref(currentType) != "33"), "onClick" to fun(){
                                                                    palyMp3(index)
                                                                }), null, 8, _uA(
                                                                    "style",
                                                                    "src",
                                                                ...
                                                                _cE("view", _uM("style" to _nS(_uM("margin-top" to "12rpx", "flex-direction" to "row", "align-items" to "center", "justify-content" to "center", "margin-bottom" to "10rpx"))), _uA(
                                                                    _cE("view", _uM("style" to _nS(_uM("flex-direction" to "row", "align-items" to "center"))), _uA(
                                                                        ...
                                                                        _cE("view", _uM("style" to _nS(_uM("width" to "80rpx"))), _uA(
                                                                            _cV(_component_wj_audio_player, _uM("audio-url" to (unref(nowItem)?.appProblemList?.get(0)?.soundInfoList?.get(0)?.soundUrl ?: ""), "auto-play" to false, "progress-color" to "#4e6ef2", "progress-height" to 12, "ref_for" to true, "ref_key" to "WjAudioPlayer1", "ref" to WjAudioPlayer1, "seekEnabled" to true, "onPlaybackCompleted" to fun(){
                                                ...
                                                if (unref(currentType) != "33") {
                                                    _cE("view", _uM("key" to 0), _uA(
                                                        if (isTrue(unref(isShowYwNot33))) {
                                                            _cE("rich-text", _uM("key" to 0, "nodes" to replaceNewlineWithBr(unref(nowItem)?.appProblemList?.get(0)?.soundInfoList?.get(0)?.originalText ?: "")), null, 8, _uA(
                                                                "nodes"
                                                            ))
                                                        } else {
                                                            _cC("v-if", true)
                                    ...
                                    if (unref(currentType) == "33") {
                                        _cE(Fragment, _uM("key" to 1), _uA(
                                            ...
                                            _cE("view", _uM("style" to _nS(_uM("padding" to "10rpx"))), _uA(
                                                _cE(Fragment, null, RenderHelpers.renderList(unref(nowItem)?.appProblemList, fun(item, index, __index, _cached): Any {
                                                    return _cE("view", null, _uA(
                                                        _cE("view", _uM("style" to _nS(_uM("align-items" to "flex-start", "flex-wrap" to "wrap", "flex-direction" to "row", "padding-bottom" to "-10rpx"))), _uA(
                                                                ...
                                                                return _cE("view", null, _uA(
                                                                    ...
                                                                    _cE("view", _uM("style" to _nS(_uM("margin-top" to "12rpx", "flex-direction" to "row", "align-items" to "center", "justify-content" to "center", "margin-bottom" to "10rpx"))), _uA(
                                                                        _cE("view", _uM("style" to _nS(_uM("flex-direction" to "row", "align-items" to "center"))), _uA(
                                                                            ...
                                                                            _cE("view", _uM("style" to _nS(_uM("width" to "140rpx"))), _uA(
                            ...
                            _cE("view", _uM("class" to "d_right"), _uA(
                                ...
                                _cE("view", _uM("style" to _nS(_uM("flex-direction" to "row", "padding" to "10rpx"))), _uA(
                                    _cV(_component_adoptResult, _uM("score" to parseInt(unref(nowItem)?.score ?: "0"), "notDone" to parseInt(unref(nowItem)?.notDoneAnswerNum ?: "0"), "failNum" to (unref(nowItem)?.errorAnswerNum ?: 0), "time" to formatTimeFn(props.secondVal), "tpl" to 2), null, 8, _uA(
                                        "score",
                                        "notDone",
                                        "failNum",
                                        "time"
