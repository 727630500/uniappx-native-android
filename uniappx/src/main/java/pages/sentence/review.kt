...
open class GenPagesSentenceReview : BasePage {
    constructor(__ins: ComponentInternalInstance, __renderer: String?) : super(__ins, __renderer) {}
    companion object {
        @Suppress("UNUSED_PARAMETER", "UNUSED_VARIABLE")
        var setup: (__props: GenPagesSentenceReview) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenPagesSentenceReview
            ...
            fun getList(subModule: String = "") {
                uni_request<Result<UTSArray<reviewItem>>>(RequestOptions(url = getUrl("/biz/problem/api/getReviewEnglishProblemList"), method = "GET", data = _uO("textbookId" to getTextBookId(), "module" to getModelKey("同步句子"), "subModule" to subModule, "leMemoryScore" to 100, "pageSize" to 3000), header = getHeader(), success = fun(res){
            ...
            watch(showStatus, fun(kVal: Number){
                val jumpUrlMap: UTSJSONObject = object : UTSJSONObject() {
                    var `1` = getSubModelKey("同步句子听力")
                    var `2` = getSubModelKey("同步句子翻译")
                    var `3` = getSubModelKey("同步句子听写")
                    var `4` = getSubModelKey("同步句子默写")
                }
            ...
            fun gen_startReview_fn() {
                ...
                val jumpUrlMap: UTSJSONObject = object : UTSJSONObject() {
                    var `1` = "/pages/sentence/hearing/test?isReview=1"
                    var `2` = "/pages/sentence/translate/test?isReview=1"
                    var `3` = "/pages/sentence/dictation/test?isReview=1"
                    var `4` = "/pages/sentence/writeSilently/test?isReview=1"
                }
                                ...
                                return _uA(
                                    _cE("view", _uM("style" to _nS(_uM("width" to "100%", "height" to "100%", "justify-content" to "center", "align-items" to "center"))), _uA(
                                        _cE("view", _uM("class" to "review_pop_box"), _uA(
                                            _cE("text", _uM("class" to "top_title"), "句子卡"),
                                            _cE("view", _uM("class" to "pop_content"), _uA(
                                                ...
                                                _cE("view", _uM("class" to "pop_content_top"), _uA(
                                                    ...
                                                    _cE("view", _uM("style" to _nS(_uM("flex-direction" to "row", "margin-top" to "8rpx", "margin-bottom" to "15rpx"))), _uA(
                                                        _cE("view", _uM("style" to _nS(_uM("margin-right" to "14rpx"))), _uA(
