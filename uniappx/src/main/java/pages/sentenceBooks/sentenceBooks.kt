...
open class GenPagesSentenceBooksSentenceBooks : BasePage {
    constructor(__ins: ComponentInternalInstance, __renderer: String?) : super(__ins, __renderer) {}
    companion object {
        @Suppress("UNUSED_PARAMETER", "UNUSED_VARIABLE")
        var setup: (__props: GenPagesSentenceBooksSentenceBooks) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenPagesSentenceBooksSentenceBooks
            ...
            val queryParams = ref(object : UTSJSONObject() {
                ...
                var subModule = getSubModelKey("句子本")
                var isExercise = "0"
            ...
            return fun(): Any? {
                ...
                return _cV(_component_PageWrap, _uM("class" to "d_page"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(_component_navbar, _uM("showBack" to true, "title" to "句子本"), _uM("right" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                _cE("view", _uM("class" to "search_box"), _uA(
                                    ...
                                    ), "class" to "search_input", "placeholder" to "请输入句子查询"), null, 40, _uA(
                                        "modelValue",
                                        "onInput"
                                    ))
                                ))
                                ...
                                _cE("scroll-view", _uM("class" to "unit_list", "direction" to "vertical"), _uA(
                                    _cE(Fragment, null, RenderHelpers.renderList(unref(unitList), fun(item, __key, __index, _cached): Any {
                                        return _cE("view", _uM("class" to "unit_item", "key" to item.id), _uA(
                                            ...
                                            _cE("text", _uM("class" to "unit_item_count"), _tD(item.problemTypeNumStat!!.problemType2Num) + "句", 1)
                                        ))
                                    }
                                    ), 128)
                                ))
                                ...
                                _cE("view", _uM("class" to "word_table"), _uA(
                                    _cE("view", _uM("class" to "word_table-header"), _uA(
                                        _cE("view", _uM("class" to "word_table-header-item"), _uA(
                                            ...
                                            _cE("text", _uM("class" to "word_table-header-item-text"), "隐藏句子")
                                        )),
                                        _cE("view", _uM("class" to "word_table-header-item"), _uA(
                                        ...
                                        _cE("view", _uM("class" to "word_table-header-item", "style" to _nS(_uM("flex" to "0.3"))), _uA(
                                                ...
                                                _cE(Fragment, null, RenderHelpers.renderList(unref(dataList), fun(item, index, __index, _cached): Any {
                                                    return _cE("list-item", _uM("key" to index), _uA(
                                                        _cE("view", _uM("class" to "word_table-body-row", "style" to _nS("" + (if (((index + 1) % 2) == 0) {
                                                            ...
                                                            _cE("view", _uM("class" to "word_table-body-item", "style" to _nS(_uM("flex" to "0.3")), "onClick" to fun(){
                                                                startLy(item, index)
                                                            }
                                                            ), _uA(
                                                                _cE("image", _uM("src" to "/static/ico/voice.png", "style" to _nS(_uM("width" to "11.72rpx", "height" to "14.41rpx")), "mode" to "aspectFit"), null, 4)
                                                            ), 12, _uA(
                                                                "onClick"
                                                            )),
                                                            _cE("view", _uM("class" to "word_table-body-item", "style" to _nS(_uM("flex" to "0.3"))), _uA(
