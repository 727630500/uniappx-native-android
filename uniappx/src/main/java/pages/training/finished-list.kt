...
open class GenPagesTrainingFinishedList : BasePage {
    constructor(__ins: ComponentInternalInstance, __renderer: String?) : super(__ins, __renderer) {}
    companion object {
        @Suppress("UNUSED_PARAMETER", "UNUSED_VARIABLE")
        var setup: (__props: GenPagesTrainingFinishedList) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenPagesTrainingFinishedList
            ...
            fun gen_goRecord_fn(item: trainingItem) {
                uni_navigateTo(NavigateToOptions(url = "/pages/training/record-list?id=" + item.id + "&name=" + item.taskName))
            }
            val goRecord = ::gen_goRecord_fn
            ...
            return fun(): Any? {
                ...
                return _cV(_component_PageWrap, _uM("class" to "d_page"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(_component_navbar, _uM("showBack" to true, "title" to "完成记录")),
                        _cE("view", _uM("class" to "d_content"), _uA(
                            _cE("view", _uM("class" to "d_right"), _uA(
                                _cE("view", _uM("class" to "word_table"), _uA(
                                    _cE("scroll-view", _uM("direction" to "vertical", "class" to "word_table-body"), _uA(
                                        _cE("view", null, _uA(
                                            _cE(Fragment, null, RenderHelpers.renderList(unref(taskList), fun(item, __key, __index, _cached): Any {
                                                return _cE("view", _uM("class" to "word_table-item"), _uA(
                                                    ...
                                                    _cE("view", _uM("class" to "word_table-item-text", "style" to _nS(_uM("margin-right" to "20rpx"))), _uA(
                                                    ...
                                                    _cE("view", _uM("style" to _nS(_uM("flex-direction" to "row"))), _uA(
                                                        _cE("view", _uM("class" to "word_table-item-text", "style" to _nS(_uM("margin-right" to "10rpx"))), _uA(
                                                            _cE("text", _uM("class" to "word_table-item-text-title"), _tD(parseFloat(item.englishScore ?: "0") ?: "--"), 1),
                                                            _cE("text", _uM("class" to "word_table-item-text-desc"), "单词得分")
                                                        ), 4),
                                                        _cE("view", _uM("class" to "word_table-item-text", "style" to _nS(_uM("margin-right" to "10rpx"))), _uA(
                                                            _cE("text", _uM("class" to "word_table-item-text-title"), _tD(parseFloat(item.grammarTrainScore ?: "0") ?: "--"), 1),
                                                            _cE("text", _uM("class" to "word_table-item-text-desc"), "语法得分")
                                                        ), 4),
                                                        _cE("view", _uM("class" to "word_table-item-text"), _uA(
                                                            _cE("text", _uM("class" to "word_table-item-text-title"), _tD(parseFloat(item.readTrainScore ?: "0") ?: "--"), 1),
                                                            _cE("text", _uM("class" to "word_table-item-text-desc"), "阅读得分")
                                                        ))
                                                    ), 4),
                                                        ...
                                                        _cE("view", _uM("style" to _nS(_uM("flex-direction" to "row", "align-items" to "center", "justify-content" to "center"))), _uA(
                                                            ...
                                                            if (item?.finishStatus == 1) {
                                                                _cE("view", _uM("key" to 1, "class" to "word_table-body-item-status", "style" to _nS(_uM("background-color" to "#CCE2EE")), "onClick" to fun(){
                                                                    ...
                                                                    _cE("text", _uM("class" to "word_table-body-item-status-text", "style" to _nS(_uM("color" to "#fff"))), "学习中", 4)
                                                                ), 12, _uA(
                                                                    "onClick"
                                                                ))
                                                            } else {
                                                    ...
                                                    _cE("text", _uM("class" to "btn-text", "onClick" to fun(){
                                                        goRecord(item)
                                                    }
                                                    ), "答题记录", 8, _uA(
                                                        "onClick"
