...
open class GenPagesWordBooksTask : BasePage {
    constructor(__ins: ComponentInternalInstance, __renderer: String?) : super(__ins, __renderer) {}
    companion object {
        @Suppress("UNUSED_PARAMETER", "UNUSED_VARIABLE")
        var setup: (__props: GenPagesWordBooksTask) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenPagesWordBooksTask
            ...
            val sendUp = fun(isPass: String, totalScore: String){
                var _data: UTSJSONObject = _uO("textbookId" to getTextBookId(), "module" to getModelKey("同步单词"), "subModule" to getSubModelKey("单词本"), "type" to "10", "isPass" to isPass, "startTime" to formatDate(null, "YYYY-MM-DD HH:mm:ss"), "studyTaskId" to studyTaskId.value, "second" to 0, "isExercise" to "0", "exerciseProblemBoList" to _uA(
                        ...
                        _cE("view", _uM("class" to "d_content"), _uA(
                            _cE("view", _uM("class" to "d_right"), _uA(
                                _cE("view", _uM("style" to _nS(_uM("flex-direction" to "row", "align-items" to "center", "height" to "30rpx", "padding" to "0 6rpx"))), _uA(
                                    _cE("text", null, " 未通过单词：" + _tD(unref(notPassNum)), 1),
                                    _cE("text", _uM("style" to _nS(_uM("margin-left" to "20rpx"))), " 已通过单词：" + _tD(unref(dataList).length - unref(notPassNum)), 5)
                                ), 4),
                                _cE("view", _uM("class" to "word_table", "style" to _nS(_uM("margin-top" to "-2rpx"))), _uA(
                                    _cE("view", _uM("class" to "word_table-header"), _uA(
                                        ...
                                        _cE("view", _uM("class" to "word_table-header-item"), _uA(
                                            _cE("text", _uM("class" to "word_table-header-item-text"), "音标")
                                        )),
                                        _cE("view", _uM("class" to "word_table-header-item"), _uA(
                                            ...
                                            _cE(Fragment, null, RenderHelpers.renderList(unref(dataList), fun(item, index, __index, _cached): Any {
                                                return _cE("list-item", _uM("key" to index), _uA(
                                                    _cE("view", _uM("class" to "word_table-body-row", "style" to _nS("" + (if (((index + 1) % 2) == 0) {
                                                        ...
                                                        _cE("view", _uM("class" to "word_table-body-item"), _uA(
                                                            _cE("text", _uM("class" to "word_table-body-item-text"), _tD(item.phoneticSymbol), 1)
                                                        )),
                                                        _cE("view", _uM("class" to "word_table-body-item"), _uA(
