...
open class GenPagesWordInterDictation : BasePage {
    constructor(__ins: ComponentInternalInstance, __renderer: String?) : super(__ins, __renderer) {}
    companion object {
        @Suppress("UNUSED_PARAMETER", "UNUSED_VARIABLE")
        var setup: (__props: GenPagesWordInterDictation) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenPagesWordInterDictation
            ...
            return fun(): Any? {
                ...
                return _cV(_component_PageWrap, _uM("class" to "d_page"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(_component_navbar, _uM("showBack" to true, "title" to "单词智能听写"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                        ...
                                        _cE(Fragment, null, RenderHelpers.renderList(unref(showList), fun(item, index, __index, _cached): Any {
                                            return _cE("view", _uM("class" to "word_table-body-row", "key" to item, "style" to _nS("" + (if (((index + 1) % 2) == 0) {
                                                ...
                                                _cE("view", _uM("class" to "word_table-body-item word_table-body-item-status-box"), _uA(
                                                    _cE("view", _uM("class" to "word_table-body-item word_table-body-item-status-box"), _uA(
                                                        _cV(_component_listBtn, _uM("item" to item, "model" to unref(getModelKey)("同步单词"), "subModule" to unref(getSubModelKey)("单词智能听写"), "onStartStudy" to startStudy, "onStartExam" to startExam), null, 8, _uA(
                                                            "item",
                                                            "model",
                                                            "subModule"
                                                        ))
