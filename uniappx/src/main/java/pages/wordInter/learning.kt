...
open class GenPagesWordInterLearning : BasePage {
    constructor(__ins: ComponentInternalInstance, __renderer: String?) : super(__ins, __renderer) {}
    companion object {
        @Suppress("UNUSED_PARAMETER", "UNUSED_VARIABLE")
        var setup: (__props: GenPagesWordInterLearning) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenPagesWordInterLearning
            ...
            val exercisePassScore = computed(fun(): Number {
                return getConfig("单词智能记忆配置").getNumber("exercisePassScore") ?: 0
            }
            )
            fun gen_getList_fn() {
            ...
            fun gen_startStudy_fn(item: teachingMaterial) {
                ...
                uni_navigateTo(NavigateToOptions(url = "/pages/wordInter/learning/learning?englishCurrentProgressValue=" + _englishCurrentProgressValue + "&englishTotalProgressValue=" + item.englishProgress.englishTotalProgressValue + "&unitTitle=" + item.unitName))
            }
            ...
            fun gen_startExam_fn(item: teachingMaterial) {
                ...
                setTextbookUnitId(item.id)
                uni_navigateTo(NavigateToOptions(url = "/pages/wordInter/learning/test?unitTitle=" + item.unitName))
            }
            ...
            return fun(): Any? {
                ...
                return _cV(_component_PageWrap, _uM("class" to "d_page"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                        _cV(_component_navbar, _uM("showBack" to true, "title" to "单词智能记忆"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
                                        ...
                                        _cE(Fragment, null, RenderHelpers.renderList(unref(showList), fun(item, index, __index, _cached): Any {
                                            return _cE("view", _uM("class" to "word_table-body-row", "key" to item, "style" to _nS("" + (if (((index + 1) % 2) == 0) {
                                                ...
                                                _cE("view", _uM("class" to "word_table-body-item word_table-body-item-status-box"), _uA(
                                                    _cV(_component_listBtn, _uM("item" to item, "model" to unref(getModelKey)("同步单词"), "subModule" to unref(getSubModelKey)("单词智能记忆"), "onStartStudy" to startStudy, "onStartExam" to startExam), null, 8, _uA(
                                                        "item",
                                                        "model",
                                                        "subModule"
                                                    ))
