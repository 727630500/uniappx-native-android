...
open class GenUniModulesLimePickerComponentsLPickerLPicker : VueComponent, PickerProps {
    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesLimePickerComponentsLPickerLPicker, _arg1: SetupContext) -> Any? = fun(__props, ref1): Any? {
            ...
            val updatePickerItems = fun(){
                ...
                if (curValueArray.value.join("") == _values.join("") && curIndexArray.value.join("") == _indexs.join("")) {
                    return
                }
